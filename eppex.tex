...
If we were to check the size of this structure, we would get astonishing value of 72
...
% This is why we sacrificed convenience of use of \emph{std::string} and backed off to C-strings
% to store string data in \eppex{}.
