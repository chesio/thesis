...
The lowercased form of tokens was also the single factor for both sides of
...
The disk usage has been measured by a separate bash script that invoked Unix
