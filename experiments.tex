...
in case of "Cs-En" setup described below, it took more than 30~hours to calculate the pruning
scores for 336~K of phrase pairs (approx. 0.1\% of the phrase table).
...
limited by the considerable memory demands of decoding: in our case, the parallel run of
...
\emph{relent-filter} into our experiments schedule, therefore we were forced to abandon it.
