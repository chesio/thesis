...
Servers with different hardware configuration has been used for experiments with
each dataset to account for different memory demands incurred by their sizes:
\begin{itemize}
  ...
  48~GB of RAM and approximately 447~GB of hard disk space. % twister2
  ...
  128~GB of RAM and approximately 558~GB of hard disk space. % lucifer[6-10]
\end{itemize}
