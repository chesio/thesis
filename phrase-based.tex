...
since there is an exponential number of choices given a particular input sentence.
The phrase-based decoders therefore usually employ some strategies to limit the search space
...
In \Cref{chap:introduction} we already came with a brief definition of a phrase
...
\Fref{fig:phrase-pair-alignment} presents snippet picked up from French-English
