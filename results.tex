...
and \emph{opt-base} experiments: while the phrase extraction time fell down from 4h~54mins to 2h~39mins
(i.e. almost to $1/2$), the scoring time jumped up a bit from 5h~31mins to 5h~38mins.
...
Memory demands of the baseline remain, the 0.1~GB difference between 2011 and now
